...
const skills = [
  { name: "React / Next.js", level: 90, color: "hsl(var(--neon-cyan))" },
  { name: "Node.js / Express", level: 85, color: "hsl(var(--neon-purple))" },
  { name: "MongoDB / MySQL", level: 80, color: "hsl(var(--neon-pink))" },
  { name: "TypeScript / JS", level: 88, color: "hsl(var(--neon-cyan))" },
  { name: "C++ / DSA", level: 85, color: "hsl(var(--neon-purple))" },
  { name: "Tailwind CSS", level: 92, color: "hsl(var(--neon-pink))" },
  { name: "Three.js", level: 75, color: "hsl(var(--neon-cyan))" },
  { name: "Git / GitHub", level: 85, color: "hsl(var(--neon-purple))" },
];
          ...
          <div>
            ...
            >
              <div className="glass-card p-6">
                <div className="mb-2 font-display text-3xl font-bold text-primary">100+</div>
                <div className="font-body text-sm text-muted-foreground">
                  DSA Problems Solved
                </div>
              </div>
              <div className="glass-card p-6">
                <div className="mb-2 font-display text-3xl font-bold text-secondary">15+</div>
                <div className="font-body text-sm text-muted-foreground">
